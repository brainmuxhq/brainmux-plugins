...
export const IMAGE_REF = "ghcr.io/brainmuxhq/brainmux-litellm@sha256:e53c8f4f012fe1286fcfd78b6a108cdf0865af21f735dd10cff47df93bf9f23f";
export function dbName(brain) {
    return `litellm_${brain}`;
}
export function masterKeyVar(brain) {
...
export function generate(cfg) {
    ...
    for (const n of names)
        configs[n] = brainConfig(cfg.brains[n].model);
